...
def test_training_set(
    ...
    *args,
    ...
    assert (
        X_train.shape[0] == 74
    ), f'Training set for training model should have 74 examples, but has {X_train.shape[0]}'
    assert (
...
def test_validation_set(
    ...
    *args,
    ...
    ), f'Training set for validation should have 3316142 examples, but has {X_val.shape[0]}'
    assert (
        X_val.shape[1] == 5094
